...
// import canvas from "../../assets/js/charts/gd-analytics.js";

const DefaultDashboard = () => {
  //loading the scripts files (trying to load scripts for individual page)
  useEffect(() => {
    const script1 = document.createElement("script");
    const script2 = document.createElement("script");
    const script3 = document.createElement("script");

    script1.src = "../../assets/js/charts/gd-general.js";
    script1.async = true;

    script2.src = "../../assets/js/charts/gd-analytics.js";
    script2.async = true;

    script3.src = "../../assets/js/charts/gd-invest.js";
    script3.async = true;
                          ...
                          <div className="nk-tb-col tb-col-sm">
                            <div className="user-card">
                              <div className="user-avatar user-avatar-sm bg-warning">
                                <img
                                  src={require("../../assets/images/avatar/b-sm.jpg")}
                                  alt=""
                                />
                              </div>
                              <div className="user-name">
                    ...
                    <ul className="nk-activity">
                      <li className="nk-activity-item">
                        <div className="nk-activity-media user-avatar bg-success">
                          <img
                            src={require("../../assets/images/avatar/c-sm.jpg")}
                            alt=""
                          />
                        </div>
                      ...
                      <li className="nk-activity-item">
                        <div className="nk-activity-media user-avatar bg-purple">
                          <img
                            src={require("../../assets/images/avatar/d-sm.jpg")}
                            alt=""
                          />
                        </div>
                        <div className="nk-activity-data">
                    ...
                    <ul className="nk-support">
                      <li className="nk-support-item">
                        <div className="user-avatar">
                          <img
                            src={require("../../assets/images/avatar/a-sm.jpg")}
                            alt=""
                          />
                        </div>
